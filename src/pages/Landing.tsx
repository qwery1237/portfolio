...
const Landing = forwardRef<HTMLDivElement, ILandingProps>(
  ({ workRef }, ref) => {
    ...
    const scrollToWork = () => {
      if (workRef.current == null) return;
      const top =
        workRef.current.getBoundingClientRect().top + scrollY.get() - 71.98 + 2;
      ...
      <Wrapper ref={ref}>
        <Greeting>
          <Line>
            ...
            <br />I build beautiful web experiences
          </Line>
          <ViewWork onClick={scrollToWork}>
